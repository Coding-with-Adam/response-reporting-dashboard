...
def get_connection(host = "127.0.0.1", host_port = 3307, logon = "root", pwd = "2024.db_admin", db = "vost_db"):
	try:
		connection = connector.connect(host = host, port = host_port, user = logon, password = pwd, database = db)
		return connection
